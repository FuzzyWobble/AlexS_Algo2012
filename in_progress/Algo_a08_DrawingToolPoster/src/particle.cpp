...
void particle::update(){	
	...
	if(abs(posHistory[posHistory.size()-1].x-pos.x)>10.0 || abs(posHistory[posHistory.size()-1].y-pos.y)>10.0){ //new point
		ofPoint tempPt;
		tempPt.set(pos.x,pos.y);
		posHistory.push_back(tempPt);
	}
