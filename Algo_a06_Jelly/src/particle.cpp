...
void particle::setDamping(float val){
	damping = val;
}
...
//------------------------------------------------------------
void particle::draw(float cx, float cy){
	
//	float angle;
//    //rotate fish
//	ofPushMatrix();
//		ofTranslate(pos.x, pos.y, 0);
//		if((vel.x==0 && vel.y==0)||(!mouseMovedMessage)){
//			angle = lastAngle; //doesnt work yet... erratic fish when mouse it not moving
//		}
//		else{
//			angle = atan2(vel.y, vel.x);
//		}
//		ofRotateZ((angle * RAD_TO_DEG)+180);
//		//draw fish
//		fish->draw(0,0, 20,20);
//		lastAngle = angle;
//	ofPopMatrix();
	float dist = ofDist(cx,cy,pos.x,pos.y);
	float alpha = (1-(dist/300))*255.0;
